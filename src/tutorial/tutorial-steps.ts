...
export const tutorialStepBodyHtml: readonly string[] = [
  ...
  "<strong>Levels:</strong> the hive has <strong>multiple floors</strong>. Use the compact <strong>Level</strong> control on the right—<strong>drag up/down</strong> or tap a floor—to switch the active level.",

...
Produce **draft** bullet points in plain language for players—balance, timing, new rules, fixes that change behavior—not refactors, tests, or internal names. Keep the bullet points simple, terse and concise. Each significant change should only be summarized in a single bullet point.

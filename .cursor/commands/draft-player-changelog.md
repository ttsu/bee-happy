...
Produce **draft** bullet points in plain language for players—balance, timing, new rules, fixes that change behavior—not refactors, tests, or internal names. Keep the bullet points simple, concise and to the point.
